      ...
      <div className="h-auto relative">
          ...
          <div className="w-full lg:w-[80%] flex max-sm:flex-col relative h-full py-4 mx-auto">
            <div className="left w-full lg:w-[50%] h-full">
              ...
              <div className="text w-full h-[75vh] ">
                <h1 className="font-bold max-sm:leading-[10vw] max-sm:text-2xl max-sm:text-center text-zinc-800 font-[bacasime antique regular] text-[2.4vw] leading-[4vw] pt-10">
                  <span className="text-[#267FCA]">
                    AC , Washing Machine , Refrigerator
                  </span>{' '}
                  Repair Service In Bhopal
                </h1>

                <div className="gola flex max-sm:flex-col max-sm:items-center w-full h-[39vh] mt-10 max-sm:bg-zinc-200 max-sm:rounded-lg max-sm:w-[79%] max-sm:ml-[10%] max-sm:h-[64vh]">
                  ...
                  <div className="circle max-sm:flex max-sm:items-center max-sm:justify-center w-full h-full">
                    ...
                    <h1 className="pl-5 max-sm:text-[3.8vw] font-semibold text-[1.2vw]">
                      Refrigerator repair<br /> Service
                    </h1>
                  </div>
            ...
            <div className="right w-full lg:w-[50%] h-full relative">
              <div className="call w-full h-[15vh] max-sm:mt-32 max-sm:-ml-24 relative">
                <button
                  className="absolute top-5 right-2 px-6 py-1 lg:px-12 lg:py-2 text-white flex items-center gap-4 rounded-full hover:font-medium lg:mt-5 cursor-pointer hover:translate-y- hover:transition-all hover:ease-linear hover:duration-150 transition-all ease-linear duration-150 transition-all ease-linear duration-150 translate-y-"
                  style={{ backgroundColor: "#267FCA" }}
                >
                  <p className="text-xl lg:text-3xl">✆</p> Contact Now
                </button>
              </div>
              <div className="form w-full relative h-[75vh]  max-w-full">
                <div className="w-[70%] h-[62vh] bg-gray-100 relative mt-12 ml-44 max-sm:ml-0 max-sm:mt-0 rounded-[8px] max-sm:w-full">
                  <form className="p-6 border-2 border-[#267FCA] absolute top-8 max-sm:top-5 max-sm:w-[89%] rounded-[8px] left-5 w-[25vw] flex flex-col justify-center">
        ...
        <div className="page3 w-full lg:w-[80%]  mt-10 flex gap-20 max-sm:flex-col max-sm:items-center relative h-auto py-4 mx-auto max-sm:w-full ">
          ...
          <div className='w-[55%] text-zinc-800 -mt-3  max-sm:w-[90%] h-full max-sm:-mt-10 '>
            <h1 className='text-[2.5vw]   font-semibold font-[bacasime antique regular] leading-[3.5vw] tracking-tight max-sm:text-[4.9vw] max-sm:leading-[8vw]'> Repair Handles All <span className='text-[#267FCA]'>Washing Machine Repair , AC ,Refrigerator </span>and Maintenance in Bhopal</h1>

            <p className='pt-10 max-sm:text-[3.5vw]'>Get the best washing machine repair and maintenance services in Bhopal from our team of experienced, trained technicians at Raju Repair. We service all brands and types of washers – front-loading, top-loading, portable – and handle repairs both minor and major.</p>

            <p className='pt-7 max-sm:text-[3.5vw]'>At our company, customer satisfaction is our top priority. That's why we offer a 30-days warranty on all repairs, ensuring that you get the best value for your money. Contact us today for all your washing machine Ac Refrigerator repair and service needs.</p>

            <p className='pt-7 max-sm:text-[3.5vw]'>Regular maintenance and service are crucial for optimal washing machine performance and cleaner laundry. breakdowns cause major household inconvenience, so we offer prompt, same-day, emergency repairs to get your washer running again ASAP. Our reliable service comes at reasonable, cost-effective pricing.</p>
          </div>
        </div>
        ...
        <div className=" emergency w-full lg:w-[80%]  mt-10 flex  gap-20 max-sm:flex-col max-sm:items-center relative  py-4 mx-auto max-sm:w-full max-sm:-mt-4 ">
          <div className='w-full h-[35vh] bg-zinc-100 rounded-[10px] mt-5 text-center'>
            ...
            <h1 className='text-[2vw] tracking-wide font-bold text-zinc-800 pt-5 max-sm:text-[4.7vw]'>Quick and Reliable Repair of Washing Machine Repair and Service</h1>
            <button
              ...
              style={{ backgroundColor: "#267FCA" }}
            >
              <p className="text-xl lg:text-4xl">✆</p>+91-70090-08812
            </button>
          </div>
        </div>
        ...
        <div className='question'>
          <section className="text-gray-700">
            <div className="container px-5 py-24 mx-auto max-sm:py-2">
        ...
        <div className='footer w-full lg:w-[100%] max-sm:flex max-sm:flex-col mt-10 max-sm:items-center relative py-4 mx-auto max-sm:w-full m max-sm:mt-[87%]'>
          ...
          <footer className="border-y border-2">
            <div className="mx-auto w-full max-w-screen-xl px-6 py-6 lg:py-8">
              ...
              <hr className="my-6 border-gray-200 sm:mx-auto lg:my-8 " />
              <div className="sm:flex bg-[#267FCA] max-sm:rounded-lg max-sm:w-[115%] max-sm:-ml-6 max-sm:-mt-4 max-sm:text-center sm:items-center sm:justify-between ">
                ...
                <div className="flex text-white justify-center max-sm:mt-0 mt-8 space-x-6">
                <div className="flex text-white justify-center mt-8 max-sm:mb-3 space-x-6">
                  <a href="#" className="text-white hover:text-gray-900">
                    <span className="sr-only">Facebook</span>
                    <svg
                      className="w-6 h-6"
